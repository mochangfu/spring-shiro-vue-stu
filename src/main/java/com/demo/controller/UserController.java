...
public class UserController extends BaseController {
    ...
    public String uploadLogo(HttpServletRequest request)throws Exception {
        ...
        uploadImg = UploadUtil.uploadImg(request, "userFile/headerImg");
        return uploadImg.get("fileName");
    }


    @GetMapping(value = "/headerImg/{filename:.+}")
    ...
    return UploadUtil.readFile( "userFile/headerImg",  filename,  response);
    }
