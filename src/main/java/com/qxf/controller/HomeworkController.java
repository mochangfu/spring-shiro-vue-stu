...
public class HomeworkController {
    ...
    @PostMapping("/delete")
    public Object delete(FileRecord fileRecord){
    ...
    @PostMapping("/add")
    public Object delete(String name, String desc, Date date, String clazz, String major){
    ...
    @PostMapping("/edit")
    public Object edit(FileRecord fileRecord){
      return null;
    }
